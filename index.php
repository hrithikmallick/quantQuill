        ...
        <div id="photoCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="photo1.jpg" class="d-block w-100" alt="Professional Writing Service">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Quality Writing</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="photo2.jpg" class="d-block w-100" alt="Timely Delivery">
                    <div class="carousel-caption d-none d-md-block">
                        <h5>On-Time Delivery</h5>
                    </div>
                </div>
                <div class="carousel-item">
                    <img src="photo3.jpg" class="d-block w-100" alt="Expert Writers">
                    <div class="carousel-caption d-none d-md-block">
